...
class ControllerInformationBlogger extends Controller {
	...
	public function index() {
		...
		$data['main_title'] = $this->language->get('main_title');
	...
	public function blogs() {
		...
		foreach ($blogs as $blog) {
			...
			if (!empty($setting['status']) && $setting['status']) {
				...
				//Limiting Dots to specific character limit 
				$length  = strlen($module_blog['description']);
				if($setting['char_limit'] >= $length){
					$dots = '';
