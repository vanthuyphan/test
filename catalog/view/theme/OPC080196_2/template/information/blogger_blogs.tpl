  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <div id="content" class="<?php echo $class; ?> all-blog"><?php echo $content_top; ?>
      ...
      <div class="panel-default">
        ...
        <p class="post_hover">
        <a class="icon zoom" title="Click to view Full Image " href="<?php echo $topic['image']; ?>" data-lightbox="example-set"><i class="fa fa-search-plus"></i></a>
        <!-- <a class="icon readmore_link" title="Click to view Read More " href="<?php echo $topic['href']; ?>"><i class="fa fa-link"></i></a> -->
        </p>
        </div>
		  </div>
		  <?php } ?>
      ...
      <div class="blog-right-content">
        ...
        <div class="blog-top">
        <div class="blog-date"><i class="fa fa-calendar-o" aria-hidden="true"></i><?php echo $topic['date_added']; ?></div>
        <div class="read-comment"><a href="<?php echo $topic['href']; ?>"><i class="fa fa-comment-o"></i><?php echo $topic['total_comments']; ?> <?php echo $entry_comment; ?></a> 
        </div>
        <div class="write-comment"><a href="<?php echo $topic['href']; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i><?php echo $text_comment; ?></a></div>
        </div>
