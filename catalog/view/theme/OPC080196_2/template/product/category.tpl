  ...
  <div class="row">
    <div id="content" class="<?php echo $class; ?> category "><?php echo $content_top; ?>
      ...
      <div class="category_filter">
        <div class="col-md-12 btn-list-grid">
          <div class="btn-group">
        ...
        <a href="<?php echo $product['quick']; ?>" data-toggle="tooltip" title="<?php echo $button_quickview; ?>"><i class="fa fa-eye" aria-hidden="true"></i></a>
            ...
            <div class="product-details">
              ...
              <div class="caption">
                ...
                <button type="button" class="wishlist" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o" aria-hidden="true"></i>
<?php echo $button_wishlist; ?></button>
                <button type="button" class="compare" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-clone" aria-hidden="true"></i>
<?php echo $button_compare; ?></button>
                </div>
                ...
                <button type="button" class="wishlist" data-toggle="tooltip" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-heart-o" aria-hidden="true"></i></button>
                <button type="button" class="compare" data-toggle="tooltip" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product['product_id']; ?>');"><i class="fa fa-clone" aria-hidden="true"></i></button>
            </div>
              </div>
