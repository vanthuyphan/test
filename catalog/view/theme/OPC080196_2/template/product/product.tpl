  ...
  <div class="row"><?php echo $column_left; ?>
    ...
    <?php } ?>
        ...
        <div class="<?php echo $class; ?>">
          ...
          <div class="description"> <!-- Megnor custom <table> Start --> 

          </div><!-- Megnor custom <table> End --> 
          <?php if ($price) { ?>
          ...
          <div id="product">
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                  <button type="button" id="button-lens" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary btn-lg btn-block"> Select Lenses</button>
              </div>
            <?php if ($minimum > 1) { ?>
		  ...
		  <div class="btn-group wish-comp">
            <button type="button"  class="btn btn-default wishlist" title="<?php echo $button_wishlist; ?>" onclick="wishlist.add('<?php echo $product_id; ?>');"><i class="fa fa-heart-o" aria-hidden="true"></i><?php echo $button_wishlist; ?></button>
            <button type="button"  class="btn btn-default compare" title="<?php echo $button_compare; ?>" onclick="compare.add('<?php echo $product_id; ?>');"><i class="fa fa-clone" aria-hidden="true"></i><?php echo $button_compare; ?></button>
          </div>
        ...
        <div class="<?php echo $class; ?>" id="tabs_info">
            ...
            <li class="active"><a href="#tab-description" class="tab-text" data-toggle="tab" data-text="<?php echo $tab_description; ?>"><span><?php echo $tab_description; ?></span></a></li>
            <?php if ($attribute_groups) { ?>
            <li><a href="#tab-specification" data-toggle="tab" class="tab-text" data-text="<?php echo $tab_attribute; ?>"><span><?php echo $tab_attribute; ?></span></a></li>
            <?php } ?>
            <?php if ($review_status) { ?>
            <li><a href="#tab-review" data-toggle="tab" class="tab-text" data-text="<?php echo $tab_review; ?>"><span><?php echo $tab_review; ?></span></a></li>
            <?php } ?>
          </ul>
	  ...
	  <div class="box related">
	   ...
	   <div class="box-heading"><span class="heading_inner"><?php echo $text_related; ?></span></div>
