...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom,#module-newstext,#module-productblock').delegate('select[name*=\'code\']', 'change', function() {
...
$('#module-column-left, #module-column-right, #module-content-top, #module-content-bottom, #module-footertop, #module-footerbottom, #module-newstext ,#module-productblock').trigger('change');
//--></script> 
</div>
<?php echo $footer; ?>